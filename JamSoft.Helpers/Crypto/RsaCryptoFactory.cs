...
namespace JamSoft.Helpers.Crypto
{
    ...
    public sealed class RsaCryptoFactory : IRsaCryptoFactory
    {
        ...
        /// <summary>
        /// Creates an instance of <see cref="IRsaCrypto"/> using the provided keys.<para />
        ...
        /// Creates an instance of <see cref="IRsaCrypto"/> using the provided keys.<para />
        /// You can provide both keys or just the private key for signing, or just the public key for verification<para />
        /// The keys can be extracted in xml format from the <see cref="IRsaCrypto.PublicKey"/> and <see cref="IRsaCrypto.PrivateKey"/> properties<para />
        /// </summary>
        /// <param name="privateKeyXml">The private key xml.</param>
        /// <param name="publicKeyXml">The public key xml.</param>
        ...
        /// <summary>
        /// Creates an instance of <see cref="IRsaCrypto" /> using the provided RSAParameters objects.<para />
        /// You can provide both keys or just the private key for signing, or just the public key for verification<para />
        /// Defaults to using <see cref="HashAlgorithmName.SHA512"/> and <see cref="RSASignaturePadding.Pkcs1"/> with a 2048-bit key<para />
        /// </summary>
        ...
        /// <summary>
        /// Creates an instance of <see cref="IRsaCrypto" /><para />
        /// Defaults to using <see cref="HashAlgorithmName.SHA512"/> and <see cref="RSASignaturePadding.Pkcs1"/> with a 2048-bit key<para />
        /// </summary>
        /// <param name="hashAlgorithmName">The hashing algorithm to use</param>
        /// <param name="padding">The padding to be used</param>
        ...
        {
            return new RsaCrypto(hashAlgorithmName, padding);
        }

        /// <summary>
        /// Creates an instance of <see cref="IRsaCrypto" /> using the provided key size, hashing and padding values<para />
        /// </summary>
        /// <param name="keySize">The integer key size to use</param>
        /// <param name="hashAlgorithmName">The hashing algorithm to use</param>
        /// <param name="padding">The padding to be used</param>
        ...
        {
            return new RsaCrypto(keySize, hashAlgorithmName, padding);
        }

        /// <summary>
        /// Creates an instance of <see cref="IRsaCrypto" /> and uses the provided RSA implementation
        /// </summary>
